...
return n.apply(this,e)}},its.emptyFunction=function(){},its.swallowEventFunction=function(t){t.preventDefault(),t.stopPropagation()},window.its.element||(window.its.element={}),its.element.createDocumentFragmentFromString=function(t){var n=document.createDocumentFragment(),r=document.createElement("div"),i;
if(its.isDefined(r.innerHTML)){r.innerHTML=t,i=r.children;
var s=i.length;
for(var o=0;
o<s;
o++)n.appendChild(i[0])}else{t=t.replace(/(<\?xml[^<>]+\?>)?([\s\S]*)/,"$1<wrapper>$2</wrapper>"),r=(new DOMParser).parseFromString(t,"text/xml"),i=r.firstChild.childNodes;
for(var o=0;
o<i.length;
o++){var u=i.item(o);
document.adoptNode(u),n.appendChild(u)}}return n},its.element.createElementFromString=function(t){var n=its.element.createDocumentFragmentFromString(t),r=n.childNodes;
...
return t!=null&&its.isDefined(t)&&(n=="false"?n=!1:n=="true"?n=!0:/(^-?\d\d*\.\d*$)|(^-?\d\d*$)|(^-?\.\d\d*$)/.test(n)&&(isFinite(parsedNumber=parseFloat(n))?n=parsedNumber:isFinite(parsedNumber=parseInt(n,10))&&(n=parsedNumber))),n},window.its.reflect||(window.its.reflect={}),its.reflect.keys=function keys(e){var keys=[];
...
return its.url.appendUrlParametersString(t,r)},its.url.appendUrlParametersString=function(t,n){t||(t="");
if(!n)return t;
var r=t.indexOf("?")===-1?"?":"&";
...
a==t&&(its.cookies._debugAndUnitTestLastRawGetCookieString=o,i=its.string.trim(o.substring(u+1)))}}}return i},its.cookies.remove=function(t,n){return its.cookies.setUnescaped(t,"",its.cookies.EXPIRE_NOW,null,n)},its.cookies._cookieOwner="iTunes"in window&&"cookie"in iTunes?"iTunes":"document",its.cookies._setRaw=function(e){return window[this._cookieOwner].cookie=e},its.cookies._getRaw=function(){return window[this._cookieOwner].cookie||""},window.iTSLocalization||(iTSLocalization={}),iTSLocalization._strings||(iTSLocalization._strings={}),iTSLocalization.hasLocalizedValue=function(t){var n=iTSLocalization._strings[t];
return its.isDefined(n)},its.loc=function(e,t){var n=iTSLocalization._strings[e];
return typeof n=="undefined"&&(n=e),t&&(n=iTSLocalization.replaceTokens(n,t)),n=iTSLocalization.replaceMarkupTokens(n,t),n},iTSLocalization._strings._showLocKeys&&(its.loc=function(e){return"+"+e+"+"}),its.locWithCount=function(e,t,n){return e===1?its.loc(t):its.loc(n,{count:e})},iTSLocalization.replaceTokens=function(t,n){if(n)for(var r in n)if(n.hasOwnProperty(r)){var i="@@"+r+"@@";
...
return r+its.loc(t)},its.formatNumber=function(e,t){if(typeof iTSLocalization.decimalSeparator=="undefined"){var n=iTSLocalization._strings._decimalSeparator;
typeof n=="undefined"&&(n="."),iTSLocalization.decimalSeparator=n,n=iTSLocalization._strings._thousandsSeparator,typeof n=="undefined"&&(n=","),iTSLocalization.thousandsSeparator=n}var r=!0;
...
return e&&(t||(n=its._dataCache[e]),n==undefined&&(n=its.string.unstringify(its.url.originalLocationQueryParams[e])),n==undefined&&(n=its.string.unstringify(sessionStorage[e])),n==undefined&&(n=its.string.unstringify(localStorage[e])),n==undefined&&window.itsv&&(n=window.itsv[e]),!t&&its.isDefined(e)&&its.isDefined(n)&&(its._dataCache[e]=n)),n},its.value=function(dataPath,key,useOverrideIfAvailable,noCache){its.value.totalCount++;
