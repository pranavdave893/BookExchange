...
window.its||(window.its={}),its.isDefined=function(t){return typeof t!="undefined"},its.isDefinedNonNull=function(t){return its.isDefined(t)&&t!=null},window.EXCEPTION_LOGGER_NAME="ITSExceptionHandler",window._itsOnErrorCallback=function(t,n,r){if(t&&t instanceof Event){var i=t.target;
...
t=t?t:1e3,ITSLogger._queuedMessages&&ITSLogger._queuedMessages.length&&t>0&&ITSLogger._delayedProcessQueuedMessages(t)},ITSLogger._processQueuedMessages=function(){ITSLogger.possiblyWaitForQueueMessages()},ITSLogger._delayedProcessQueuedMessages=function(t){window.setTimeout(ITSLogger._processQueuedMessages,t)},ITSStopwatch=function e(t){this.reset(),t||(t="default"),this._name=t,this._hasLoggedToServer=!1,e.stopwatches||(e.stopwatches={}),e.stopwatches[t]=this},ITSStopwatch.named=function(t){var n=null;
