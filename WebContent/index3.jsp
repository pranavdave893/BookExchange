...
<div id="searchbar">
			 <b class="style3"> Search:
			 <input name="txtsearch" type="text" class="text" size="40" maxlength="400"/>			 
			 &nbsp;      &nbsp;
			  <input type="submit" value="Go" class="submit" onclick="form.action='searchpage.jsp?value=null';"/>
		 
 	   </div>
		
		 <div id="left-stack1" class="font">
                          ...
                          <%
		                      ...
		                      for(Iterator<typedetail> i1= objList1.iterator(); i1.hasNext();)
		                        ...
		                        %>
		                        	...
		                        	<li class='has-sub'><a href="searchpage.jsp?value=<%=td1.getTypeid()%>"><%=td1.getTypename()%></a>
		                         ...
		                         <%}
			                      for(Iterator<typedetail> i2= objList2.iterator(); i2.hasNext();)
			                        ...
			                        %>
			                        <li class='last'><a href="searchpage.jsp?value=<%=td2.getTypeid()%>"><%=td2.getTypename()%></a></li>
