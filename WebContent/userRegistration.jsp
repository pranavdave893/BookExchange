...
{
var x=document.forms.user.txtusername.value;
if (x==null || x=="")
  {
...
{
	var pass=document.forms.user.txtpassword.value;
	var verypass=document.forms.user.txtverifypassword.value;
	if(pass!==verypass)
		{
...
{
var a=document.forms.user.txtemail.value;
var atpos=a.indexOf("@");
...
{
	var phone_no=document.forms.user.txtphoneno.value;
	var phoneno = /^\d{10}$/;   
...
{
	var pin_code=document.forms.user.txtpincode.value;
	//var pin_code1=document.forms.user.txtpincode.value.length;
	//alert("pin length=="+pin_code1);
	var pincode=/^\d{6}$/;
...
function chkradio()
{
var elem=document.forms.user.elements.gender;
len=elem.length-1;
chkvalue='';
for(i=0; i<=len; i++)
{
...
<script type="text/javascript">
	function msg(email,pass)
	{
		alert("Record Inserted....");
		//window.open("userprofile.jsp?email="+email+"&pass="+pass);
	}
</script>
       ...
       <center>
        <table border="0">
          ...
          <tr>
            ...
            <label>
                <input type="text" name="txtusername" onblur="validateForm()">
              </label>                        </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <label>
                <input type="text" name="txtemail" onblur="validateEmail()">
              </label>                        </td>
          </tr>
          ...
          <tr>
            ...
            <td>
              <label>
                <input type="password" name="txtpassword" onblur="validateForm()">
              </label>                        </td>
          </tr>
          <tr>
            ...
            <td>
              <label>
                <input type="password" name="txtverifypassword" onblur="passValidation()">              </label>                        </td>
          </tr>
          <tr>
            ...
            <td><select name="studytype">
              <option>Select study type</option>
				...
				List<typedetail> objList=objSell.setBookView("gettypedetail",5,0);
          ...
          <tr>
            ...
            <td>
                ...
                <textarea name="txtaddress"></textarea>                                 </td>
          </tr>
          <tr>
            <td align="right">*City</td>
            <td><select name="txtcity" onblur="validateForm()">
          ...
          <tr>
            ...
            <td>
                <input type="text" name="txtstate" value="Gujarat" readonly="readonly" >              </td>
          </tr>
          <tr>
            <td align="right">Phone no</td>
            <td>
                <input type="text" name="txtphoneno" onblur="">                               </td>
          </tr>
          <tr>
            <td align="right">*Pin Code</td>
            <td>
              <label>
                <input type="text" name="txtpincode" onblur="pincodecheck()">
              </label>                        </td>
          </tr>
          <tr>
            ...
            <td>
              ...
              Female</label>
              <label>
                <input name="gender" type="radio" value="male" onblur="chkradio()">
                Male</label>            </td>
          </tr>
          ...
          <tr>
           ...
           <!--  <a href="updateuser.jsp?querylink_email=geetajsca@gmail.com">Update</a>
